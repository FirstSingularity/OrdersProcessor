...
public class StudentTests extends TestCase {
	...
	public void testSys1() throws Exception, Throwable {
		runProgramWithInput("studentTest1.txt");
	}
	
	public void testSys2() throws Exception, Throwable {
		runProgramWithInput("studentTest2.txt");
	}

	public void testSys3() throws Exception, Throwable {
		runProgramWithInput("studentTest3.txt");		
	}
	
	public void testSys4() throws Exception, Throwable {
		runProgramWithInput("studentTest4.txt");
	}
	
	public void testSys5() throws Exception, Throwable {
		runProgramWithInput("studentTest5.txt");
	}
	
	public void testSys6() throws Exception, Throwable {
		runProgramWithInput("studentTest6.txt");
	}
